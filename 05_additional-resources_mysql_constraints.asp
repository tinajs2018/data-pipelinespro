...
<h1>MySQL <span class="color_h1">Constraints</span></h1>
<div class="w3-clear nextprev">
  <a class="w3-left w3-btn" href="mysql_alter.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="mysql_notnull.asp">Next &#10095;</a>
</div>
<hr>
...
CREATE TABLE <em>table_name </em>(<br>
 <em>&nbsp;&nbsp;&nbsp; column1 datatype</em> <em>constraint</em>,<br>
 <em>&nbsp;&nbsp;&nbsp; column2 datatype</em> <em>constraint</em>,<br>
 <em>&nbsp;&nbsp;&nbsp; column3 datatype</em> <em>constraint</em>,<br>
&nbsp;&nbsp;&nbsp;
....<br>
);
</div>
...
<ul>
  <li><code class="w3-codespan"><a href="mysql_notnull.asp">NOT NULL</a></code> - Ensures that a column cannot have a NULL value</li>
  <li><code class="w3-codespan"><a href="mysql_unique.asp">UNIQUE</a></code> - Ensures that all values in a column are 
  different</li>
  <li><code class="w3-codespan"><a href="mysql_primarykey.asp">PRIMARY KEY</a></code> - A combination of a 
  <code class="w3-codespan">NOT NULL</code> and <code class="w3-codespan">UNIQUE</code>. 
  Uniquely identifies each row in a table</li>
  <li><code class="w3-codespan"><a href="mysql_foreignkey.asp">FOREIGN KEY</a></code> 
  - Prevents actions that would destroy links between tables</li>
  <li> <code class="w3-codespan"><a href="mysql_check.asp">CHECK</a></code> - Ensures that 
  the values in a column satisfies a specific condition</li>
  <li> <code class="w3-codespan"><a href="mysql_default.asp">DEFAULT</a></code> - Sets a default value for a column 
  if no value 
  is specified</li>
  <li> <code class="w3-codespan"><a href="mysql_create_index.asp">CREATE INDEX</a></code> - Used to create and retrieve data from the database 
  very quickly</li>
</ul>
